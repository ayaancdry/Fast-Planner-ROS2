...
void Astar::setParam(std::shared_ptr<FastPlanner> nh) {
  nh->declare_parameter<float>("astar/resolution_astar", 0);
  nh->declare_parameter<float>("astar/time_resolution", 0);
  nh->declare_parameter<float>("astar/lambda_heu", 0);
  nh->declare_parameter<float>("astar/margin", 0);
  nh->declare_parameter<int>("astar/allocate_num", 0);
