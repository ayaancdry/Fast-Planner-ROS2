...
void TopologyPRM::init(const rclcpp::Node::SharedPtr& nh) {
  ...
  nh->declare_parameter("topo_prm/sample_inflate_x", sample_inflate_(0));
  nh->declare_parameter("topo_prm/sample_inflate_y", sample_inflate_(1));
  nh->declare_parameter("topo_prm/sample_inflate_z", sample_inflate_(2));
  nh->declare_parameter("topo_prm/clearance", clearance_);
  nh->declare_parameter("topo_prm/short_cut_num", short_cut_num_);
  nh->declare_parameter("topo_prm/reserve_num", reserve_num_);
  nh->declare_parameter("topo_prm/ratio_to_short", ratio_to_short_);
  nh->declare_parameter("topo_prm/max_sample_num", max_sample_num_);
  nh->declare_parameter("topo_prm/max_sample_time", max_sample_time_);
  nh->declare_parameter("topo_prm/max_raw_path", max_raw_path_);
  nh->declare_parameter("topo_prm/max_raw_path2", max_raw_path2_);
  nh->declare_parameter("topo_prm/parallel_shortcut", parallel_shortcut_);
