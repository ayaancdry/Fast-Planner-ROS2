...
private:
  /* ---------- flag ---------- */
  enum FSM_EXEC_STATE { INIT, WAIT_TARGET, GEN_NEW_TRAJ, REPLAN_TRAJ, EXEC_TRAJ, REPLAN_NEW, RECOVERY};
  ...
  double no_replan_thresh_, replan_thresh_,curr_yaw_;
  ...
  geometry_msgs::msg::Point pos_pt;
  ...
  rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr pos_cmd_flag_pub_;
  ...
  void pos_cmd_input(const quadrotor_msgs::msg::PositionCommand::SharedPtr msg);
  void rotate_2pi();
public:
  KinoReplanFSM(/* args */);
  ~KinoReplanFSM();
