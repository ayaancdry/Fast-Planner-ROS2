...
class TrajServer : public rclcpp::Node
{
  public:
    ...
    {   
        ...
        pos_cmd_flag_sub = this->create_subscription<std_msgs::msg::Bool>("/position_cmd_flag", 50, std::bind(&TrajServer::cmd_flag_cb, this, std::placeholders::_1));
...
private:
  ...
  void cmd_flag_cb(const std_msgs::msg::Bool::SharedPtr msg){
    cmd_flag=msg->data;
  }
  ...
  void cmdCallback() {
    ...
    rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr pos_cmd_flag_sub;
